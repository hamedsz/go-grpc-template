...
type SampleServiceClient interface {
	CreateSample(ctx context.Context, in *NewSample, opts ...grpc.CallOption) (*Sample, error)
}
...
func (c *sampleServiceClient) CreateSample(ctx context.Context, in *NewSample, opts ...grpc.CallOption) (*Sample, error) {
	out := new(Sample)
	err := c.cc.Invoke(ctx, "/sample.SampleService/CreateSample", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SampleServiceServer interface {
	CreateSample(context.Context, *NewSample) (*Sample, error)
...
func (UnimplementedSampleServiceServer) CreateSample(context.Context, *NewSample) (*Sample, error) {
...
func _SampleService_CreateSample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sample.SampleService/CreateSample",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServiceServer).CreateSample(ctx, req.(*NewSample))
	}
